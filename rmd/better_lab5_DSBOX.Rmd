...
For accessibility purposes, the required data frames of Denny's and La Quinta are saved as local variables.
...
states <- read_csv(here("data","raw","states.xlsx"))
```
...
```{r}
FastFoodRestaurants <- read_csv(here("data","raw","FastFoodRestaurants.csv"))
