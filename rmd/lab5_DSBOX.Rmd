...
library(readxl)
states <- read_xlsx("C:/Users/tarak/Desktop/states.xlsx")
```
...
Among the states examined and analzyed, Mitch Hedberg's joke is most likely to hold true in the state of Texas because the visualization by Texas showed an abundance of locations where there were a Denny's and La Quinta close by.
