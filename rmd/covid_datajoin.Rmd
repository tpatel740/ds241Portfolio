...
The here package allows us to use a simpler function call to read in the data
...
We will only visualize data since 10th confirmed death.
...
ggplot(data = df1,
  ...
  labs(
    x = "Days since 10th confirmed death",
    y = "Total Cases",
    title = "Total Cases from COVID-19, selected countries",
    subtitle = glue("Data as of", as_of_date_formatted, .sep = " "),
    caption = "Source: github.com/RamiKrispin/coronavirus")
```
